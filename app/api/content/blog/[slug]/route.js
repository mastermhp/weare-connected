...
export async function GET(request, { params }) {
  try {
    ...
    if (post) {
      console.log(`Blog API: Found post in database: ${post.title}`)
      const formattedPost = {
        ...post,
    ...
    console.log("Blog API: Post not found in database, checking sample data")
  } catch (error) {
  ...
  if (samplePost) {
    console.log(`Blog API: Found post in sample data: ${samplePost.title}`)
  ...
  console.log(`Blog API: Post not found anywhere for slug: ${slug}`)
