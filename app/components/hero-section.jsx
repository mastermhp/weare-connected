      ...
      <div className="container px-4 md:px-6 relative z-10 pt-20">
        <div className="flex flex-col items-center space-y-8 text-center max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            <h1 className="text-5xl md:text-5xl lg:text-5xl font-bold tracking-tight leading-tight">
            ...
            <div className="space-y-4 max-w-4xl mx-auto">
              <p className="text-xl md:text-2xl font-medium text-slate-700">
                Innovative ventures that shape industries and move culture forward.
              </p>
              <p className="text-sm md:text-md text-slate-600">
                From AI-powered platforms to sustainable lifestyle brands, we create solutions that matter.
              </p>
            </div>
          </div>
