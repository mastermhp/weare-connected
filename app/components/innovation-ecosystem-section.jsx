...
export default function InnovationEcosystemSection() {
  ...
  const ecosystemNodes = [
    {
      ...
      status: "Established",
      connections: ["fintech", "ecommerce", "ai", "mobile", "enterprise"],
    },
    {
      id: "fintech",
      title: "FinTech",
  ...
  const resources = [
    {
      title: "Vision Papers",
      description: "Exploring the future of digital innovation",
      icon: <Lightbulb className="w-5 h-5" />,
    },
    {
      title: "Concept Frameworks",
      description: "Methodologies for breakthrough thinking",
      icon: <Target className="w-5 h-5" />,
    },
    {
      title: "Opportunity Maps",
      description: "Identifying untapped market potential",
      icon: <Globe className="w-5 h-5" />,
    },
    {
      title: "Launch Playbooks",
      description: "Strategies for bringing ideas to market",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Explore our ecosystem of emerging ventures and bold ideas that are just beginning their journey from
              concept to reality.
            </p>
          </motion.div>
          ...
          >
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-8">
              <div>
                <h3 className="text-2xl font-bold text-white">Resource Hub</h3>
              </div>
              <div>
                <Link href="/resources" className="inline-flex items-center text-white hover:text-purple-400">
                  Explore More
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {resources.map((resource) => (
                <div
                  key={resource.title}
                  className="bg-black/60 backdrop-blur-sm rounded-lg p-4 border border-gray-800"
                >
